module.exports = {
  ...
  content: [
    ...
    "content/**/*.{md,mdoc,yaml,json}",
    "lib/**/*.{js,ts}",
    // Retained as a compatibility safelist for the pre-Keystatic case-study
    // archive. New and restored bodies are repository-backed Markdoc.
