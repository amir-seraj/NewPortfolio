...
<div class="mb-8 p-6 bg-gradient-to-r from-green-500 to-blue-600 text-white rounded-lg">
  <h2 class="text-2xl font-bold mb-2 text-white">🎮 Perfect Posture Case Study</h2>
  <p class="text-lg opacity-90 mb-4">Enhancing Gamers' Health Through Ergonomic Intervention</p>
  <div class="flex flex-wrap gap-2">
    <span class="px-3 py-1 rounded-full bg-white/20 text-sm">User Research</span>
    <span class="px-3 py-1 rounded-full bg-white/20 text-sm">Prototype Testing</span>
    <span class="px-3 py-1 rounded-full bg-white/20 text-sm">Computer Vision</span>
    <span class="px-3 py-1 rounded-full bg-white/20 text-sm">Ergonomics</span>
  </div>
</div>
...
<div class="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-r-lg mb-6">
...
<div class="space-y-8">
  <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md dark:">
  ...
  <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md dark:">
    ...
    <div class="bg-green-50 dark:bg-green-900/20 p-4 mt-4">
...
<div class="mt-12 p-6 bg-gradient-to-r from-green-500 to-blue-600 text-white rounded-lg text-center">
  <h3 class="text-xl font-bold mb-2 text-white">🎯 Project Impact</h3>
...
<div class="mb-8 p-6 bg-gradient-to-r from-teal-500 to-blue-600 text-white rounded-lg">
  <h2 class="text-2xl font-bold mb-2 text-white">🌊 Unity at Sea: Crafting a Soundscape of Shared Balance</h2>
  ...
  <div class="flex flex-wrap gap-2">
    <span class="px-3 py-1 rounded-full bg-white/20 text-sm">Interactive Art</span>
    <span class="px-3 py-1 rounded-full bg-white/20 text-sm">Sound Design</span>
    <span class="px-3 py-1 rounded-full bg-white/20 text-sm">Kinect</span>
    <span class="px-3 py-1 rounded-full bg-white/20 text-sm">EyesWeb</span>
    <span class="px-3 py-1 rounded-full bg-white/20 text-sm">Collaboration</span>
  </div>
</div>

<div class="mb-8 p-6 bg-teal-50 dark:bg-teal-900/20 rounded-r-lg">
...
<div class="bg-teal-50 dark:bg-teal-900/20 p-6 mb-8">
...
<div class="grid md:grid-cols-3 gap-4 mb-8">
  <div class="bg-gray-800 text-white p-4 rounded-lg text-center">
    <h4 class="font-semibold mb-2 text-white">🎵 Audio Design</h4>
    <p class="text-sm opacity-90">Three-state dynamic soundscape</p>
  </div>
  <div class="bg-gray-800 text-white p-4 rounded-lg text-center">
    <h4 class="font-semibold mb-2 text-white">👥 Social Interaction</h4>
    <p class="text-sm opacity-90">Enhanced group awareness</p>
  </div>
  <div class="bg-gray-800 text-white p-4 rounded-lg text-center">
    <h4 class="font-semibold mb-2 text-white">⚖️ Balance Sensing</h4>
...
<div class="mt-12 p-6 bg-gradient-to-r from-teal-500 to-blue-600 text-white rounded-lg text-center">
  <h3 class="text-xl font-bold mb-2 text-white">🌊 Project Legacy</h3>
  <p class="opacity-90 mb-4">
...
<div class="mb-8 p-6 bg-gradient-to-r from-purple-500 to-pink-600 text-white rounded-lg">
  <h2 class="text-2xl font-bold mb-2 text-white">🎭 reSilence: AI-Powered Mirror for Emotional Wellbeing</h2>
  ...
  <div class="flex flex-wrap gap-2">
    <span class="px-3 py-1 rounded-full bg-white/20 text-sm">Computer Vision</span>
    <span class="px-3 py-1 rounded-full bg-white/20 text-sm">Python</span>
    <span class="px-3 py-1 rounded-full bg-white/20 text-sm">Max/MSP</span>
    <span class="px-3 py-1 rounded-full bg-white/20 text-sm">OpenCV</span>
    <span class="px-3 py-1 rounded-full bg-white/20 text-sm">MediaPipe</span>
  </div>
</div>
...
<div class="mb-8">
  <img src="/images/reSilence/architecture.svg" alt="System Architecture Diagram" class="w-full max-w-2xl mx-auto rounded-lg shadow-md" />
</div>
...
<div class="grid md:grid-cols-2 gap-6 mb-6">
  <div class="dark:bg-gray-700 p-4 rounded-lg dark:">
...
<div class="bg-purple-50 dark:bg-purple-900/20 p-6 mb-8">
...
<div class="grid md:grid-cols-3 gap-4 mb-8">
  <div class="bg-gray-800 text-white p-4 rounded-lg text-center">
    <h4 class="font-semibold mb-2 text-white">🔬 Research Impact</h4>
    <p class="text-sm opacity-90">Published findings on bio-feedback in interactive art</p>
  </div>
  <div class="bg-gray-800 text-white p-4 rounded-lg text-center">
    <h4 class="font-semibold mb-2 text-white">🎯 User Engagement</h4>
    <p class="text-sm opacity-90">Average session time: 25+ minutes</p>
  </div>
  <div class="bg-gray-800 text-white p-4 rounded-lg text-center">
    <h4 class="font-semibold mb-2 text-white">🏆 Recognition</h4>
...
<div class="mt-12 p-6 bg-gradient-to-r from-purple-500 to-pink-600 text-white rounded-lg text-center">
  <h3 class="text-xl font-bold mb-2 text-white">🎯 Project Reflection</h3>
  <p class="opacity-90 mb-4">
...
<div class="mb-8 p-6 bg-gradient-to-r from-orange-500 to-red-600 text-white rounded-lg">
  <h2 class="text-2xl font-bold mb-2 text-white">🎵 Creating an Ontology for Hip-Hop Music</h2>
  ...
  <div class="flex flex-wrap gap-2">
    <span class="px-3 py-1 rounded-full bg-white/20 text-sm">Ontology Design</span>
    <span class="px-3 py-1 rounded-full bg-white/20 text-sm">Knowledge Engineering</span>
    <span class="px-3 py-1 rounded-full bg-white/20 text-sm">React</span>
    <span class="px-3 py-1 rounded-full bg-white/20 text-sm">SPARQL</span>
  </div>
</div>
...
<div class="grid md:grid-cols-3 gap-4 mb-8">
  <div class="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md dark:">
...
<div class="grid md:grid-cols-2 gap-6 mb-8">
  <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-r-lg">
  ...
  <div class="bg-green-50 dark:bg-green-900/20 p-4 rounded-r-lg">
  ...
  <div class="bg-purple-50 dark:bg-purple-900/20 p-4 rounded-r-lg">
  ...
  <div class="bg-orange-50 dark:bg-orange-900/20 p-4 rounded-r-lg">
...
<div class="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg mb-8">
  ...
  <blockquote class="pl-4 italic text-gray-600 dark:text-gray-400 mb-4">
...
<div class="grid md:grid-cols-3 gap-4 mb-8">
  <div class="bg-gradient-to-br from-blue-500 to-blue-600 text-white p-4 rounded-lg text-center">
    <h4 class="font-semibold mb-2 text-white">🎶 By Genre</h4>
  ...
  <div class="bg-gradient-to-br from-green-500 to-green-600 text-white p-4 rounded-lg text-center">
    <h4 class="font-semibold mb-2 text-white">📅 By Date (Recent)</h4>
  ...
  <div class="bg-gradient-to-br from-purple-500 to-purple-600 text-white p-4 rounded-lg text-center">
    <h4 class="font-semibold mb-2 text-white">⏱️ By Duration</h4>
...
<div class="mt-12 p-6 bg-gradient-to-r from-orange-500 to-red-600 text-white rounded-lg text-center">
  <h3 class="text-xl font-bold mb-2 text-white">🎯 Project Achievement</h3>
  <p class="opacity-90 mb-4">
...
<div class="mb-8 p-6 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-lg">
  <h2 class="text-2xl font-bold mb-2 text-white">🚀 ETH Course Marketplace</h2>
  ...
  <div class="flex flex-wrap gap-2">
    <span class="px-3 py-1 rounded-full bg-white/20 text-sm">Next.js</span>
    <span class="px-3 py-1 rounded-full bg-white/20 text-sm">Solidity</span>
    <span class="px-3 py-1 rounded-full bg-white/20 text-sm">Web3.js</span>
    <span class="px-3 py-1 rounded-full bg-white/20 text-sm">Ethereum</span>
    <span class="px-3 py-1 rounded-full bg-white/20 text-sm">MetaMask</span>
  </div>
</div>

<div class="mb-8 p-6 bg-blue-50 dark:bg-blue-900/20 rounded-r-lg">
...
<div class="grid md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
  <div class="bg-gray-800 text-white p-4 rounded-lg text-center">
    <h4 class="font-semibold mb-2 text-white">🔗 Full-Stack Web3</h4>
    <p class="text-sm opacity-90">Complete dApp Development</p>
  </div>
  <div class="bg-gray-800 text-white p-4 rounded-lg text-center">
    <h4 class="font-semibold mb-2 text-white">⛽ Gas Optimized</h4>
    <p class="text-sm opacity-90">Efficient Smart Contracts</p>
  </div>
  <div class="bg-gray-800 text-white p-4 rounded-lg text-center">
    <h4 class="font-semibold mb-2 text-white">🌍 Multilingual</h4>
    <p class="text-sm opacity-90">Global Accessibility</p>
  </div>
  <div class="bg-gray-800 text-white p-4 rounded-lg text-center">
    <h4 class="font-semibold mb-2 text-white">📱 Responsive</h4>
...
<div class="-t-2 my-8"></div>

<h2 class="text-2xl font-bold mb-6 text-gray-900 dark:text-white">💡 Technical Challenges & Solutions</h2>

<div class="space-y-6 mb-8">
  <div class="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg dark:">
...
<div class="mt-12 p-6 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-lg text-center">
  <h3 class="text-xl font-bold mb-2 text-white">🎯 Project Summary</h3>
  <p class="opacity-90 mb-4">
...
<div class="mb-8 p-6 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-lg">
  <h2 class="text-2xl font-bold mb-2 text-white">💼 Jobify: A Full-Stack Job Application Tracker</h2>
  ...
  <div class="flex flex-wrap gap-2">
    <span class="px-3 py-1 rounded-full bg-white/20 text-sm">MongoDB</span>
    <span class="px-3 py-1 rounded-full bg-white/20 text-sm">Express.js</span>
    <span class="px-3 py-1 rounded-full bg-white/20 text-sm">React</span>
    <span class="px-3 py-1 rounded-full bg-white/20 text-sm">Node.js</span>
    <span class="px-3 py-1 rounded-full bg-white/20 text-sm">JWT</span>
  </div>
</div>

<div class="mb-8 p-6 bg-indigo-50 dark:bg-indigo-900/20 rounded-r-lg">
...
<div class="mt-12 p-6 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-lg text-center">
  ...
  {
    slug: "emotion-recognition-games-dataset",
    title: "Emotion Recognition in Games",
    tags: ["Affective Computing", "Computer Vision", "Dataset", "Python"],
    description:
      "A multimodal dataset and facial-expression pipeline for emotion recognition in a video-game context.",
    body: `
<p class="text-gray-700 dark:text-gray-300 mb-4">
  A multimodal dataset and analysis pipeline for recognising player emotion in a video-game context.
  The repository covers the full loop: extracting faces from gameplay footage, running facial
  expression recognition, and matching detections back to game events.
</p>
<ul class="space-y-1 text-gray-700 dark:text-gray-300 mb-6">
  <li>Face extraction from recorded sessions</li>
  <li>Facial expression recognition (FER) detection notebooks</li>
  <li>Event matching between affect signals and gameplay</li>
</ul>
<p class="text-gray-700 dark:text-gray-300 mb-6">Built with Python and Jupyter. Part of the same research line as Perfect Posture: what games do to the people playing them, measured.</p>
<div class="text-center mb-8">
  <a href="https://github.com/amir-seraj/Emotion-recognition" target="_blank" rel="noopener noreferrer" class="inline-block px-6 py-3 bg-gray-900 dark:bg-gray-700 text-white hover:bg-gray-800 dark:hover:bg-gray-600 transition-colors">View on GitHub</a>
</div>
`,
    coverImage: "https://opengraph.githubassets.com/1/amir-seraj/Emotion-recognition",
    socialImage: "https://opengraph.githubassets.com/1/amir-seraj/Emotion-recognition",
...
<p class="text-gray-700 dark:text-gray-300 mb-6">
  A face verification pipeline built in Jupyter notebooks: detecting, aligning and comparing faces to
  decide whether two images show the same person. The computer-vision groundwork that the emotion
  recognition and reSilence work builds on.
</p>
<div class="text-center mb-8">
  <a href="https://github.com/amir-seraj/Facial-verification" target="_blank" rel="noopener noreferrer" class="inline-block px-6 py-3 bg-gray-900 dark:bg-gray-700 text-white hover:bg-gray-800 dark:hover:bg-gray-600 transition-colors">View on GitHub</a>
</div>
`,
    coverImage: "https://opengraph.githubassets.com/1/amir-seraj/Facial-verification",
    socialImage: "https://opengraph.githubassets.com/1/amir-seraj/Facial-verification",
    publishedAt: "2024-11-25",
    readTime: "3",
  },
  {
    slug: "arts-for-wellbeing",
    title: "Arts for Wellbeing",
    tags: ["Affective Computing", "Movement Analysis", "Audio", "Research"],
    description:
      "Emotion and movement analysis for an arts-and-wellbeing study, from facial affect models to graded aggression soundscapes.",
    body: `
<p class="text-gray-700 dark:text-gray-300 mb-4">
  A research project pairing affect sensing with the arts: analysing emotion and movement to study
  how artistic interventions influence wellbeing.
</p>
<ul class="space-y-1 text-gray-700 dark:text-gray-300 mb-6">
  <li>Facial emotion analysis built on a RAF-DB trained model</li>
  <li>Movement analysis notebooks</li>
  <li>Graded audio stimuli (low / medium / high aggression soundscapes)</li>
</ul>
<div class="text-center mb-8">
  <a href="https://github.com/amir-seraj/Arts-for-wellbeing-project" target="_blank" rel="noopener noreferrer" class="inline-block px-6 py-3 bg-gray-900 dark:bg-gray-700 text-white hover:bg-gray-800 dark:hover:bg-gray-600 transition-colors">View on GitHub</a>
</div>
`,
    coverImage: "https://opengraph.githubassets.com/1/amir-seraj/Arts-for-wellbeing-project",
    socialImage: "https://opengraph.githubassets.com/1/amir-seraj/Arts-for-wellbeing-project",
    publishedAt: "2024-12-05",
    readTime: "4",
  },
  {
    slug: "ai-image-video-pipeline-framework",
    title: "AI Image & Video Pipeline Framework",
    tags: ["Generative AI", "Python", "VLM", "3D"],
    description:
    ...
    body: `
<p class="text-gray-700 dark:text-gray-300 mb-4">
  A Python framework for building and running generative media pipelines: image, video and 3D.
  One codebase orchestrates vision-language models, 3D reconstruction (InstantMesh, Hunyuan3D)
  and texture generation, with reproducible environments and scripted runs.
</p>
<ul class="space-y-1 text-gray-700 dark:text-gray-300 mb-6">
  <li>Direct VLM invocation and scripted pipelines</li>
  <li>3D generation and painting experiments (Hunyuan3D, InstantMesh)</li>
  <li>FP8 compilation tests for faster inference</li>
</ul>
<p class="text-gray-700 dark:text-gray-300 mb-6">Active project, 2026.</p>
<div class="text-center mb-8">
  <a href="https://github.com/amir-seraj/AI-Image-Video-Pipeline-Framework" target="_blank" rel="noopener noreferrer" class="inline-block px-6 py-3 bg-gray-900 dark:bg-gray-700 text-white hover:bg-gray-800 dark:hover:bg-gray-600 transition-colors">View on GitHub</a>
</div>
`,
    coverImage: "https://opengraph.githubassets.com/1/amir-seraj/AI-Image-Video-Pipeline-Framework",
    socialImage: "https://opengraph.githubassets.com/1/amir-seraj/AI-Image-Video-Pipeline-Framework",
  ...
  },
  {
    slug: "metagoogler",
    title: "MetaGoogler",
    tags: ["Python", "LLM", "Desktop App", "Audio"],
    description:
      "A desktop app for audiophiles: audio fingerprinting, AI-suggested metadata and intelligent cover-art fetching.",
    body: `
<p class="text-gray-700 dark:text-gray-300 mb-4">
  A song-metadata management system for audiophiles. It identifies tracks by audio fingerprinting,
  suggests corrected metadata with LLMs, and fetches and embeds cover art, all from a desktop GUI.
</p>
<ul class="space-y-1 text-gray-700 dark:text-gray-300 mb-6">
  <li>Audio fingerprinting via the AudD API, sampled mid-song for accuracy</li>
  <li>Metadata suggestions from 13+ switchable LLM providers</li>
  <li>Batch processing, validation and auto-rename to "Artist - Title"</li>
  <li>CustomTkinter GUI with a live metadata sidebar</li>
</ul>
<p class="text-gray-700 dark:text-gray-300 mb-6">Python. Active project, 2026.</p>
<div class="text-center mb-8">
  <a href="https://github.com/amir-seraj/MetaGoogler" target="_blank" rel="noopener noreferrer" class="inline-block px-6 py-3 bg-gray-900 dark:bg-gray-700 text-white hover:bg-gray-800 dark:hover:bg-gray-600 transition-colors">View on GitHub</a>
</div>
`,
    coverImage: "https://opengraph.githubassets.com/1/amir-seraj/MetaGoogler",
    socialImage: "https://opengraph.githubassets.com/1/amir-seraj/MetaGoogler",
...

  {
    slug: "shodocode",
    title: "Shodocode",
    tags: ["Next.js", "React", "TypeScript", "EdTech", "Spaced Repetition"],
    description:
    ...
    body: `
<p class="text-gray-700 dark:text-gray-300 mb-4">
  Calligraphers master strokes by copying the master until the hand remembers. Shodocode teaches
  algorithms the same way, through a three-step loop:
</p>
<ul class="space-y-1 text-gray-700 dark:text-gray-300 mb-6">
  <li><strong>Think</strong> through the problem with guided questions</li>
  <li><strong>Watch</strong> the solution unfold with synchronized visualizations</li>
  <li><strong>Drill</strong> the solution by typing it until the pattern becomes familiar</li>
</ul>
<p class="text-gray-700 dark:text-gray-300 mb-4">
  Around that loop: progress tracking, spaced-repetition reviews, achievements, daily challenges,
  algorithm variant comparisons, and admin tooling for content quality.
</p>
<p class="text-gray-700 dark:text-gray-300 mb-6">
  Built with Next.js 16, React 19 and TypeScript; Drizzle ORM (SQLite locally, Postgres in
  production), NextAuth, Zustand, Vitest and Playwright, with Sentry instrumentation.
  In active development, 2026. Source is private.
</p>
<div class="text-center mb-8">
  <a href="https://shodocode.com" target="_blank" rel="noopener noreferrer" class="inline-block px-6 py-3 bg-gray-900 dark:bg-gray-700 text-white hover:bg-gray-800 dark:hover:bg-gray-600 transition-colors">Visit shodocode.com</a>
</div>
`,
    coverImage: "/images/Shodocode/banner.jpg",
    socialImage: "/images/Shodocode/banner.jpg",
    publishedAt: "2026-07-03",
    readTime: "4",
  },

  {
    slug: "est-generic-event-boundary-detector-thesis",
    title: "An EST-Based Generic Event Boundary Detector",
    tags: ["Computer Vision", "Cognitive Science", "Vision Transformers", "Self-Supervised Learning", "MSc Thesis"],
    description:
    ...
    body: `
<p class="text-gray-700 dark:text-gray-300 mb-4">
  Humans segment continuous experience into discrete events automatically, registering a boundary
  whenever their prediction of what happens next fails. This thesis operationalises that theory,
  Event Segmentation Theory (EST), as a 15-channel feature representation and three
  self-supervised encoders (a Vision Transformer, a GRU autoencoder, and a predictive extension),
  then asks a harder question than most theses attempt: not just "does it work," but
  <em>why does it stop working where it does</em>.
</p>
<div class="mb-8 p-6 bg-gradient-to-r from-teal-600 to-emerald-700 text-white rounded-lg">
  <h2 class="text-2xl font-bold mb-2 text-white">The honest result</h2>
  <p class="text-lg opacity-90 mb-2">MCC@15 = 0.405 on Assembly101, 0.593 on Breakfast &mdash; and a diagnostic explaining precisely why no model in the family goes higher.</p>
  <p class="opacity-80 text-sm">Supervisors: Prof. Gualtiero Volpe (Genova) &middot; Prof. Giovanna Varni (Trento). Defended June 2026.</p>
</div>
<h2 class="text-2xl font-bold mb-4 text-gray-900 dark:text-white">What it found</h2>
<ul class="space-y-2 text-gray-700 dark:text-gray-300 mb-6">
  <li>&bull; The per-frame boundary score genuinely carries signal &mdash; ground-truth frames score 1.75&times; higher than non-boundary frames.</li>
  <li>&bull; But 77&ndash;79% of every model's predicted boundaries still land nowhere near a real one: the noise has a heavier tail than the signal.</li>
  <li>&bull; Even an oracle that knows the true number of boundaries per video recovers fewer than one in five.</li>
  <li>&bull; The two reconstruction-based encoders transfer across datasets (Assembly101 &harr; Breakfast) without meaningful loss &mdash; the ceiling tracks the test corpus, not the encoder.</li>
</ul>
<p class="text-gray-700 dark:text-gray-300 mb-6">
  The published version of this work appeared at CHItaly 2025. The thesis re-evaluates everything
  under a stricter, unified protocol, and the headline number from the paper does not survive it &mdash;
  which became the more interesting finding. The forward direction it points to: score boundaries on
  a 2-D temporal self-similarity manifold instead of a 1-D per-frame scalar, the same turn the rest of
  the field has been making since 2022.
</p>
<div class="text-center mb-8">
  <a href="https://doi.org/10.1145/3750069.3755958" target="_blank" rel="noopener noreferrer" class="not-prose inline-block px-6 py-3 bg-gray-900 dark:bg-gray-700 text-white no-underline hover:bg-gray-800 dark:hover:bg-gray-600 transition-colors">Read the published paper (CHItaly 2025)</a>
</div>
`,
    coverImage: "/images/Thesis/banner.jpg",
    socialImage: "/images/Thesis/banner.jpg",
