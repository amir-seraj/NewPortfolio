...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "home" (
  	...
  	"contact_kicker" varchar DEFAULT 'One address. No form.',
  ...
  CREATE TABLE "settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"site_name" varchar DEFAULT 'Amir Seraj',
  	"site_url" varchar DEFAULT 'https://amirseraj.ir',
  	"default_description" varchar,
  	"default_og_image" varchar DEFAULT '/images/banner.jpg',
  	"email" varchar DEFAULT 'amirseraj.ir@gmail.com',
  	"twitter_handle" varchar DEFAULT '@amirseraj',
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
  ...
  ALTER TABLE "home_hero_lines" ADD CONSTRAINT "home_hero_lines_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."home"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "home_hero_strip" ADD CONSTRAINT "home_hero_strip_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."home"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "home_about_stats" ADD CONSTRAINT "home_about_stats_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."home"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "home_hero_lines_order_idx" ON "home_hero_lines" USING btree ("_order");
  CREATE INDEX "home_hero_lines_parent_id_idx" ON "home_hero_lines" USING btree ("_parent_id");
  CREATE INDEX "home_hero_strip_order_idx" ON "home_hero_strip" USING btree ("_order");
  CREATE INDEX "home_hero_strip_parent_id_idx" ON "home_hero_strip" USING btree ("_parent_id");
  ...
  CREATE INDEX "home_about_stats_order_idx" ON "home_about_stats" USING btree ("_order");
  CREATE INDEX "home_about_stats_parent_id_idx" ON "home_about_stats" USING btree ("_parent_id");`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "home_hero_lines" CASCADE;
  DROP TABLE "home_hero_strip" CASCADE;
  DROP TABLE "home_about_paragraphs" CASCADE;
  DROP TABLE "home_about_stats" CASCADE;
